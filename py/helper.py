...
class UnicodeProcessor:
    ...
    def _preprocess_text(self, text: str, lang: str) -> str:
        ...
        # Use NFKC rather than NFKD: NFKD decomposes Cyrillic Й/й into
        # И/и + COMBINING BREVE; downstream unsupported-character filters can
        # then drop the breve and make Й sound like И. NFKC preserves the
        # composed Cyrillic letters while still applying compatibility cleanup.
